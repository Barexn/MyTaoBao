...
public class UpdataAddressActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addressName.setText(intent.getStringExtra("name"));
        addressPhone.setText(intent.getStringExtra("phone"));
        tvCity.setText(intent.getStringExtra("city2"));
        ...
        tvBaocun.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Request request = new Request.Builder()
                        .url("http://192.168.23.144/mobile/index.php?act=member_address&op=address_edit")
                        .post(formBody)
                        .build();
                ...
                call.enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(UpdataAddressActivity.this, "修改成功...", Toast.LENGTH_SHORT).show();
                                startActivity(new Intent(UpdataAddressActivity.this,AddressActivity.class));
                                finish();
                            }
                        });
